    ...
    while True:
        ...
        if choice == '1':
            ...
            try:
                ...
                mot_de_passe_a_verifier = getpass.getpass("Entrez le mot de passe à vérifier : ")
            ...
            cost_factor = get_cost_factor()
            while True:
                mot_de_passe = getpass.getpass("Entrez le mot de passe (ou tapez 'quit' pour arrêter) : ")
