...
export const InterfaceUpdateSchema = schemaForType<InterfaceUpdateType>()(
  z.object({
    ...
    i4: ISchema,
    i5: ISchema,
    headerProtectionKey: z.string().pipe(safeStringRefine).nullable(),
    contentPaddingAddition: HSchema,
    rekeyAfterTime: HSchema,
    rekeyTimeout: HSchema,
    rejectAfterTime: HSchema,
    keepaliveTimeout: HSchema,
    maxHandshakeAttempts: HSchema,
