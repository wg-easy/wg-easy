ALTER TABLE `clients_table` ADD `header_protection_key` text;--> statement-breakpoint
...
ALTER TABLE `clients_table` ADD `random_trailers` integer;--> statement-breakpoint
