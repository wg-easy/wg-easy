...
| `WG_MTU` | `null` | `1420` | The MTU the clients will use.                                                                                           |
| `WG_SERVER_MTU` | `` | `1420` | The MTU of the server, independent of WG_MTU, it defaults to Wireguard defaults if not set (1420). |
